...
ActiveRecord::Schema.define(version: 2021_12_02_151355) do
  ...
  create_table "devs", force: :cascade do |t|
    ...
    t.index ["company_id"], name: "index_devs_on_company_id"
    t.index ["freebie_id"], name: "index_devs_on_freebie_id"
  end
